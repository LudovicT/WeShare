<div id="new_film">
			<form method="post" action="/WeShare/Films/Editer/<?php echo (generateUrl($infoMovie['Name'])."/".$infoMovie['IdMovie']); ?>/">
				...
				<span  style="text-align:left;"><label>Durée :</label><input type="text" value="<?php echo $infoMovie['Runtime']; ?>"  id="Runtime" name="Runtime" style="width:100px;" size="1" /> min</span><br /><br />
