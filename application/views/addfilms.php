<div id="new_film">
			<form method="post" action="/WeShare/Films/addFilms/">
				<span><label>Titre du film :</label><input type="text" value="" id="titre_film" name="titre" class="recherche" /></span><br /><br />
				...
				<span><label>Date Realisation :</label><input type="text" value="" id="date_realisation" name="date_realisation" /></span><br /><br />
